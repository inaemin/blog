...
export function MobileMenu({ items }: MobileMenuProps) {
  ...
  return (
    <div className="relative md:hidden">
      ...
      {isOpen && (
        <div className="absolute right-0 top-13 z-10 flex h-[106px] w-[300px] flex-col gap-0.5 rounded-2xl border border-border bg-surface p-2 shadow-[0_8px_24px_#00000014]">
          {items.map((item) => {
