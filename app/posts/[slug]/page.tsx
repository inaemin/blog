...
import {
  DesktopArticleToc,
  InlineArticleToc,
} from "@/components/post/ArticleToc";
import {
      ...
      <div className="relative grid min-w-0 gap-8 xl:grid-cols-[820px_295px] xl:gap-16 xl:pt-3.5">
        <article className="flex min-w-0 flex-col gap-12">
          <div
            ...
            className="flex min-w-0 flex-col gap-5.5 md:gap-6.5 xl:gap-10"
          >
            <header className="flex flex-col gap-4 border-b border-border pb-5 md:gap-4.5 md:pt-2 xl:gap-5">
              ...
              <h1 className="text-[28px] leading-8.5 font-bold text-foreground md:text-[34px] md:leading-10.25 xl:text-[38px] xl:leading-11">
                {post.title}
              </h1>
